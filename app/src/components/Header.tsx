    ...
    return (
        <header className="fixed top-0 left-0 right-0 bg-white px-4 py-4 flex justify-between items-center z-50">
            ...
            <nav className="hidden md:flex space-x-8 absolute left-1/2 transform -translate-x-1/2">
                <Link href="http://localhost:3000/" className="text-gray-600 hover:text-purple-600 text-lg">
                    Home
                </Link>
                <Link href="http://localhost:3000/pre-grant/test" className="text-gray-600 hover:text-purple-600 text-lg">
                    Grants
                </Link>
